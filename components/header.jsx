...
const Header = () => {
  return (
    // 1. HEADER: 
    // - 'flex': Creates layout container.
    // - 'justify-between': Pushes children to opposite ends (Logo left, Auth right).
    // - 'items-center': Vertically centers the Logo and Auth buttons.
    <header suppressHydrationWarning className=" fixed top-0 w-full border-b bg-background/80 backdrop-blur-md z-50 support-[backdrop-filter]:bg-background/60 flex justify-between items-center px-6 py-3">
